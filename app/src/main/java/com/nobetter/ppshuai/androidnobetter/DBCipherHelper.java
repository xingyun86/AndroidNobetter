...
/**
 * Created by PPSHUAI on 2017/2/25.
 */


public class DBCipherHelper extends SQLiteOpenHelper {
    private static final String TAG = "DatabaseHelper";
    private static final String DB_NAME = "/data/data/com.tencent.mm/MicroMsg/30f0aa18ab29bfc12ef38c6f21131c7a/EnMicroMsg.db";//"test_cipher_db";//数据库名字
    public static final String DB_PWD="c6e800d";//"whoislcj";//数据库密码
